...
sed -i 's#<fsas_nodedriver_binary_url>#'https://github.com/cichy19/gotestworkflow/alpha/releases/download/\<placeholder\>/docker-machine-driver-fsas'#g' ./ci_tools/fsas_nodedriver_template.yml
